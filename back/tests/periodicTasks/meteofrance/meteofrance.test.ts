...
describe('meteofrance', () => {
    ...
    describe('- should fail', async () => {
        ...
        it('- retry failed calls 5 times and stop', async () => {
    ...
    describe('- should succeed', async () => {
        ...
        it('- get an observation and log it but not repeat the log if the timestamp doesnt change on second call', async () => {
            await periodicMeteoFranceCheck();
