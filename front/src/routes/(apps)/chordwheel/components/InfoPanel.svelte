<div class="contents">
    <div>
        ...
        >
        it is intended for my personal use. If you are using this implementation you should consider
        <a
            href="https://chordwheel.com/index.php?option=com_content&view=article&id=16&Itemid=4"
            target="_blank"
            rel="noopener noreferrer">buying his book</a
        >
        or
        <a
            href="https://apps.apple.com/us/app/the-chord-wheel/id444931977"
            target="_blank"
            rel="noopener noreferrer">his app</a
