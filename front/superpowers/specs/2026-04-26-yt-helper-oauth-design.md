...
| Topic                                       | URL                                                                                              |
| ------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| OAuth 2.0 for client-side web apps (Google) | https://developers.google.com/identity/protocols/oauth2/javascript-implicit-flow                 |
| OAuth 2.0 PKCE for web server apps (Google) | https://developers.google.com/identity/protocols/oauth2/web-server                               |
| Google OAuth 2.0 Playground (testing)       | https://developers.google.com/oauthplayground                                                    |
| Authorization endpoint                      | `https://accounts.google.com/o/oauth2/v2/auth`                                                   |
| Token endpoint                              | `https://oauth2.googleapis.com/token`                                                            |
| YouTube Data API v3 overview                | https://developers.google.com/youtube/v3/getting-started                                         |
| Subscriptions: list endpoint                | https://developers.google.com/youtube/v3/docs/subscriptions/list                                 |
| YouTube API scopes                          | https://developers.google.com/youtube/v3/guides/auth/client-side-web-apps#identify-access-scopes |
...
The `PUBLIC_` prefix follows the existing convention (see `env.local`). Access via SvelteKit's static env import:
